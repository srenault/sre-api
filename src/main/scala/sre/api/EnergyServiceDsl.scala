...
trait EnergyServiceDsl[F[_]] extends Http4sDsl[F] {
  ...
  object DateFromQueryParamMatcher extends OptionalValidatingQueryParamDecoderMatcher[LocalDate]("dateFrom")
  object DateToQueryParamMatcher extends OptionalValidatingQueryParamDecoderMatcher[LocalDate]("dateTo")
}
